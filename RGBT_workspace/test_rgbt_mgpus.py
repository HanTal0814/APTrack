...
from lib.test.tracker.bat import APTrack
...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=300, debug=0, script_name='adapter'):
    ...
    if script_name == 'bat':
        ...
        mmtrack = APTrack(params)  # "GTOT" # dataset_name
        tracker = APTrack_RGBT(tracker=mmtrack)
...
if __name__ == '__main__':
    ...
    if dataset_name == 'GTOT':
        ...
        seq_home = '/home/zjnu/Desktop/disk/data/lasher/testingset'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
